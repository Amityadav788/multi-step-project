...
notify(17);
document.querySelector(".notify2").addEventListener("click", () => {
	notify(2);
});
document.querySelector(".notify6").addEventListener("click", () => {
	notify(6);
});
document.querySelector(".notify12").addEventListener("click", () => {
	notify(12);
});
document.querySelector(".notify12NoLimit").addEventListener("click", () => {
	notify(12, {upperLimit: 13});
});
document.querySelector(".notify5Gold").addEventListener("click", () => {
	notify(5, {bellColor: 'goldenrod', ballColor: 'goldenrod', badgeColor: 'purple'});
});
document.querySelector(".notify2Slow").addEventListener("click", () => {
	notify(2, {ringSpeed: 2000});
});
document.querySelector(".notify2NoOutline").addEventListener("click", () => {
	notify(2, {outlineWidth: 0});
});
document.querySelector(".notify99").addEventListener("click", () => {
	notify(99, {ringSpeed: 75, upperLimit: 100});
});
